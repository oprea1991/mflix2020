...
public class MovieDao extends AbstractMFlixDao {
    ...
    public Document getMovie(String movieId) {
        ...
        //System.out.println ("match aaa " + match);
        pipeline.add(match);
        //System.out.println ("joinWithComments  aaa" + joinWithComments);

        pipeline.add(joinWithComments);

        Document movie = moviesCollection.aggregate(pipeline).first();
       // System.out.println ("movie  aaa" +movie);
        return movie;
    }
    ...
    public List<Document> getMoviesByCountry(String... country) {
        ...
        Bson projection = new Document("title", 1); //id is added by default
